...
return(
  <>
<footer
  class="bg-orange-200 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
  ...
  <div class="  mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="">
        ...
        <p class="mb-4">
        <Link 
           href="/in-home-boarding" 
           class="text-neutral-600 dark:text-neutral-200">
          
            In-home Boarding</Link>
        </p>
        <p>
        <Link 
