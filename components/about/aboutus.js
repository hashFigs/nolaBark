  ...
  return (
    ...
    <section class="container space-y-4 mx-auto px-6 p-10">
      <p className="text-sm text-gray-600 dark:text-gray-200 leading-6 font-normal">Welcome to Treme Tails Pet Services, your trusted pet walking service in the heart of the city! 
        ...
        <p className="text-sm text-gray-600 dark:text-gray-200 leading-6 font-normal">Our team of experienced and trained pet professionals is passionate 
        about animals and committed to ensuring your pet &apos;s safety and well-being. We take the time to get to know your
         ...
         <p className="text-sm text-gray-600 dark:text-gray-200 leading-6 font-normal">We believe in open and honest communication with our clients 
