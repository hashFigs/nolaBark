      ...
      <Layout home>
        <div class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-6 gap-8">
          ...
          <div class="rounded border-gray-300 dark:border-gray-700 border-dashed border-2 h-24">
            ...
            <p>
              Book appointments as you need them or set a recurring weekly
              schedule. Pet care journals are sent to your phone after every
              visit with their GPS tracked route, photos, and notes from the
              walker.
            </p>
            <ul>
              <li>15 MINUTES: $19</li>
          ...
          <div class="rounded border-gray-300 dark:border-gray-700 border-dashed border-2 h-24">
            ...
            <p>
              For a boarding alternative to the kennel at the same price, your
              dog can stay with us and enjoy all the comforts of home! We have a
              very playful pup, so guests must be current on all vaccinations
              and dog-friendly. Space is limited, advance reservations highly
              recommended.
            </p>
